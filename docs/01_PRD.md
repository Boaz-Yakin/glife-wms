# PRD-001: WMS_APP (현장 작업자용 모바일/PWA 재고관리 및 피킹 시스템)
...
**버전**: v1.0  
**관련 문서**: 
- [DB 개선 사항](file:///c:/Users/boazn/Projects/WMS/WMS_APP/docs/DB%20%EA%B0%9C%EC%84%A0%20%EC%82%AC%ED%95%AD.md)
- [재고관리 및 피킹 시스템 구성 제안](file:///c:/Users/boazn/Projects/WMS/WMS_APP/docs/%EC%9E%AC%EA%B3%A0%EA%B4%80%EB%A6%AC_%EB%B0%8F_%ED%94%BC%ED%82%B9_%EC%8B%9C%EC%8A%A4%ED%85%9C_%EA%B5%AC%EC%84%B1_%EC%A0%9C%EC%95%88.md)
- [바코드 시스템 설계서](file:///c:/Users/boazn/Projects/WMS/WMS_APP/docs/Glife%20WMS%20Barcode%20System.md)
- [ADR 아키텍처 결정](file:///c:/Users/boazn/Projects/WMS/WMS_APP/docs/02_ADR.md)
...
## 4. Out of Scope — MVP 제외 사항 (WMS_APP vs WEB_APP 경계)

WMS_APP의 극단적 경량성과 속도 유지를 위해 다음 기능은 **WEB_APP(사무실 관리자용 웹)**으로 이관하고 WMS_APP 구현에서 제외합니다.

- ❌ **대시보드 종합 매출/출고 통계 및 엑셀 다운로드** (WEB_APP 전용)
- ❌ **상품/매장/로케이션 마스터 신규 등록 및 수정** (WEB_APP 전용)
- ❌ **바코드 라벨 대량 템플릿 출력(Zebra/브라더 프린터 네트워크 연동)** (WEB_APP 전용)
- ❌ **주문 수기 생성/변경 및 매장 청구서 발행** (WEB_APP 및 기존 g-manager 전용)
